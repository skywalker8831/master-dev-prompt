...
| `.github/workflows/validate-master-dev-prompt.yml` | GitHub Actions workflow — runs `make ci` on push/PR |
| `.github/workflows/validate-mock.yml` | GitHub Actions workflow — runs batch script in mock mode on every PR |
